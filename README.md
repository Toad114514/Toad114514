...
## 关于我自己
从某个粤西拥有 **大量山卡拉地区的城市** 来的初三low炮，写出的代码没啥经验就是拉（能用就行<br>
...
<details>
 <summary>成分表</summary>
 <p>说出来你可能不信，但你现在看到的这位是混迹于机圈、玩机圈、剪辑圈、数码圈、mc圈、马里奥圈和ba圈，有ks号和噼里啪啦的号，剪视频流利尤其是NodeVideo最拿手，擅长剪魔怔、模拟恐怖、神人视频、偏漫剪、jumpstyle风格和外网风格，玩过ut、fnf、mc、迷你世界、植物大战僵尸、冰与火之舞、泰拉瑞亚、圣安地列斯、Doom一代和二代、SuperTux（包括SuperTuxKart）、雷神之锤一代、半条命、85%以上的马里奥游戏（包括任天堂官方出的大众、小众马里奥系列和比较大众的同人作［例如SMMWE这些］）、死亡细胞、元气骑士、元气骑士前传、模拟城市、老点的FC和一点点的卡比系列游戏，喜欢看8bitguy、喷神james等频道的老东西测评，LinuxTechTips等频道的新东西测评，数码评测，差评君，模拟恐怖类作品和一些高质量二创（也包括ba的），会编程（特别是Python、bash脚本和前端），会搞termux，有树莓派3b和一堆垃圾，会自己刷机（包括解bl锁和隐藏root权限都是自己搞），喜欢类原生系统和MD3设计语言（不指安卓16类原生设计），会搞github和github pages、readthedocs这类的静态部署网站，还有个gitee的账号，会搞虚拟机和自己注册steam账号，向往Frutiger Aero美学，喜欢梦核美学，也别喜欢听PsyTrance、Trance（红色电音极地大冲击）、Phonk、巴西Funk、CityPop、合成器浪潮和怀旧老歌（beyond的特别好听），马里奥狂热粉（估计），xp喜欢小的，以前是星野厨现在是中务桐乃厨（都是蔚蓝档案的，还有桐乃的记忆大厅真的好有感觉）的蘑菇王国大聪明一个<br>（大聪明马里奥制造2里属于降至人物，但这个却一点也不降至）</p>
 <p>bro能在我快15岁的同龄段给我找一个符合上述所有神秘成分的吗？</p>
</details>
...
<details>
   <summary>主力机</summary>
   <p>这是新的主力机！刷了PixelOS类原生的一加Ace2</p>
